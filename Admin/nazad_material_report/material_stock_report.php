...
// join stock_return on raw_materials.id=stock_return.material_id
...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="container card">
            ...
            <div class="h3 text-bold"><?php $now = date("Y-m-d");
                                        echo $now; ?></div>
            <div class="text-left">
                <?php
                $eerror = "";
                ...
                <form action="" method="post">
                    <div class="d-flex float-sm-left">
                        ...
                        <div>
                            <input type="text" name="name" class="form-control" id="name" value="<?php if (isset($name)) {echo $name;} ?>" placeholder="product name" required>
                            <span style="color:red" id="e_error"><?php echo $eerror; ?></span>
                        </div>
                        <div class="width-100%" >
                            <input class="btn btn-secondary" type="submit" class="form-control" name="submit" value="Search">
                        </div>
                ...
                <tbody>
                    ...
                    foreach ($product as $ui => $ul) { ?>
                        <tr>
                            ...
                            <td><a class="btn btn-primary" href="material_report.php?id=<?php echo $ul['id'] ?>&name=<?php echo $ul['name'] ?>">Details</a></td>
                        </tr>
