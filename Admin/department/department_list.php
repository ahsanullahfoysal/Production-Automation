                            ...
                            <tbody>
                                <?php foreach ($dep as $i => $p) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="department_edit.php?id=<?php echo $p['id'] ?>" class="btn btn-success">Update</a>

                                            <a href="department_delete.php?id=<?php echo $p['id'] ?>" class="btn btn-danger" onclick="return confirm('are you sure to delete')">Delete</a>
                                        </td>
                                    </tr>
                                <?php } ?>
