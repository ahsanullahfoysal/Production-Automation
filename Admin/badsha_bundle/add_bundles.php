            ...
            <div>
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title"><a href="bundle_list.php" class="btn btn-primary btn-md">Bundles List</a></h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="bundle_code" class="form-control" id="bundle_code" placeholder="Enter Bundle Code"><span id="error2"></span>
                                    </div>
                                </div> 
                            </div>
