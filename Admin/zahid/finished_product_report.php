...
<script>
    function validate(){
        ...
        if(project== ''){
            ...
            document.getElementById('project_error').innerHTML='select a project';
            return false;
        }else{
      
            document.getElementById('project').style.border='1px solid green';
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <form action="" method="post" onsubmit="return validate()" class="form-inline">
                ...
                <div class="col-sm-6">
                    <form action="" method="post" onsubmit="return fn()" class="form-inline float-sm-right">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <?php foreach ($data as $i => $p) { ?>
                                    ...
                                    <tr>
                                        <td><?php echo ++$i ?></td>
                                        <td><?php $projects = $con->query("select * from projects where id=" . $p['project_id'])->fetch_assoc();
                                            echo $projects['name'] ?></td>
                                        <td>
                                            <?php echo $p['quantity'] ?>
                                            <?php $qun = $p['quantity'] ?>
                                        </td>
