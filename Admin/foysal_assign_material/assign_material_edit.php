...
<script>
     function fj() {
        ...
        let orders_id = (document.querySelector('#orders_id').value).trim();

        if (name == '' || quantity == '' || orders_id == '') {
            if (name == '') {
            ...
            if (orders_id == '') {
                document.querySelector('#orders_id').style.border = '1px solid red';
                document.querySelector('#orders_id_error').innerHTML = 'orders_id Required';
            } else {
                document.querySelector('#orders_id').style.border = '1px solid green';
                document.querySelector('#orders_id_error').innerHTML = '';
            }
            return false;
        } else {
            return true;
        ...
        <div class="container-fluid">
            ...
            <div>
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form action="" method="post" enctype="multipart/form-data" onsubmit=" return fj()">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-6">
                                <div class="form-group">
                                        ...
                                        <option value="<?php echo $raw['id']?>" <?php if($raw['id']==$mn['material_id']){echo "selected";}?>> 
                                            <?php echo $raw['name'] ?>
                                        </option>
                                        <?php }?>
                                    </select>
                                ...
                                <div class="form-group">
                                        ...
                                        <input type="text" name="quantity" class="form-control" id="quantity" placeholder="Enter quantity" value="<?php echo $mn['quantity'] ?>"><span style="color: red;" id="quantity_error">*</span>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Orders</label>
                                        <input type="text" name="orders_id" class="form-control" id="orders_id" placeholder="Enter title" value="<?php echo $mn['orders_id'] ?>"><span style="color: red;" id="orders_id_error">*</span>
                                    </div>
