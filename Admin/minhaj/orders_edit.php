...
if(isset($_POST['submit'])){
    ...
    $con->query("UPDATE `orders` SET `project_id`='$project',`buyer_id`='$buyer',`start_date`=' $start_date',`end_date`='$end_date',`quantity`='$quantity',`unit_id`='$unit',`project_manager_id`=' $manager',`supervisor_id`=' $supervisor',`rate`='$rate',stutus='$status' WHERE id=$id "); 
    ?>
    <script>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <select name="status" id="" class="form-control">
                                            ...
                                            <?php while ($c = $status->fetch_assoc()) {?>
                                                <option value="<?php $c['id'] ?>"<?php if($c['id']==$edit['id']){echo "selected";} ?>><?php echo $c['status'] ?></option>
                                           <?php } ?>
                                        </select>
                                    </div>
                                </div>
