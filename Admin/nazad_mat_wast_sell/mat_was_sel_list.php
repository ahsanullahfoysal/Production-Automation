                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-md-2 offset-8 text-right">
                                <a href="<?php echo $_SESSION['base_url'] ?>/nazad_mat_wast_sell/mat_sell_add.php" class="btb btn-warning">Add Wastage Material</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="text-left">
                                <form action="" method="post">
                                    ...
                                    <input type="text" name="name" id="name" value="<?php if (isset($name)) {
                                                                                        echo $name;
                                                                                    } ?>" placeholder="name/buyer" required>
                            ...
                            <tbody>
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="mat_sell_edit.php?id=<?php echo $p['id'] ?>" class="btn btn-success btn-sm">Update</a>

                                            <a href="mat_sell_delete.php?id=<?php echo $p['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('are you sure to delete')">Delete</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                                <tr>
                                    <td class="text-right text-bold h5" colspan="7">Total Sell :</td>
                                    <td class="text-bold h5" colspan="2"><?php echo $total . " . " . "Tk"; ?></td>
                                </tr>
