...
?>
    <script>
        function d_validation() {
            let start_date = document.getElementById("s_date").value;
            let end_date = document.getElementById("e_date").value;
            console.log(start_date);
            console.log(end_date);
            if (start_date == '' || end_date == '') {
                if (start_date == '') {
                    document.getElementById("s_date").style.border = 'red';
                    document.getElementById("s_date_error").innerHTML = 'Please Input js From Date';
                    document.getElementById("s_date_error").style.color = 'red';
                } else {
                    document.getElementById("s_date").style.border = 'green';
                    document.getElementById("s_date_error").innerHTML = '';
                }
                if (end_date == '') {
                    document.getElementById("e_date").style.border = 'red';
                    document.getElementById("e_date_error").innerHTML = 'Please Input js TO Date';
                    document.getElementById("e_date_error").style.color = 'red';
                } else {
                    document.getElementById("e_date").style.border = 'green';
                        ...
                        <?php foreach ($buyer as $i => $p) { ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="buyer_pay_delete.php?id=<?php echo $p['id'] ?>" class="btn btn-danger" onclick="return confirm('Are You sure?')">Delete</a>
                                </td>
