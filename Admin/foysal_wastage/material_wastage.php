...
if (isset($_POST['material_id'])) {
    ...
    //     if($material_id==''){
    //         $_SESSION['material_idError']="material_id is Requried!";
    //     }
    //     if($quantity==''){
    //         $_SESSION['quantityError']="quantity is Requried!";
    //     }
    //     if($date==''){
    //         $_SESSION['dateError']="date is reqiried";
    //     }
    ...
    // }
    // header('location:material_wastage.php');
