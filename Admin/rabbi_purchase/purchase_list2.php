                ...
                <div class="col-sm-4">
                    <form action="#" class="form-inline" method="POST">
                        <div class="form-group">
                            ...
                            <a href="purchase_list.php" class="btn btn-primary" style="margin-left: 15px;">Individual Edit</a>
                        </div>
                    </form>
                </div>
                <div class="col-sm-8">
                    <form action="#" class="form-inline float-sm-right" method="POST">
                        <div class="form-group">
                            ...
                            <input type="date" name="date1" class="form-control" id="exampleInputEmail1" placeholder="Enter title">
                            <label for="exampleInputEmail1">To</label>
                            <input type="date" name="date2" class="form-control" id="exampleInputEmail1" placeholder="Enter title">
                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-md-2 offset-8 text-right">
                                <a href="<?php echo $_SESSION['base_url'] ?>/rabbi_purchase/add_purchase.php" class="btn btn-warning">Add Purchase</a>
                            </div>
                        </div>
                    </div>
                    <!-- /.card-header -->
                            ...
                            <tbody>
                                <?php foreach ($products as $i => $p) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="purchase_update2.php?id=<?php echo $p['invoice_id'] ?>" class="btn btn-success btn-sm">Update</a>
                                            <a href="delete_purchase2.php?id=<?php echo $p['invoice_id'] ?>" class="btn btn-danger btn-sm">Delete</a>
                                            <a href="view_purchase.php?id=<?php echo $p['invoice_id'] ?>" class="btn btn-success btn-sm" target="_blank">View</a>
                                        </td>
                                    </tr>
                                <?php } ?>
